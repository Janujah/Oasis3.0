...
//           <Image 
//           // src={logo} 
//           alt="Company Logo" className="h-12 w-12" />
//         </div>
...
//         <button
//           className="w-full py-2 px-4 bg-indigo-600 text-white font-semibold rounded-md shadow-sm hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
//           type="submit"
//           disabled={loading}
//           id='button'          
//         >
...
//           If you don't have an account <a href="/signup" className="text-indigo-600 hover:underline" style={{color:'#0e0737'}}>Sign up</a>
//         </div>
//       </form>
//     </div>
//   );
